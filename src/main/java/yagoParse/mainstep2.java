...
public class mainstep2 {
    ...
    public static Logger LOG = LoggerFactory.getLogger(mainstep2.class);
...
//        conf.set("mapreduce.textoutputformat.separator", ",");
        Job job = Job.getInstance(conf, "yago_parse_step2");
        job.setJarByClass(step2.class);
        job.setMapperClass(step2.step2YagoMap.class);
