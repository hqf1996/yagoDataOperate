...
public class mainstep6 {
    public static String fs = "hdfs://10.1.18.221:8020";//hdfs://10.1.18.221:8020   psd:hdu52335335
    public static Logger LOG = LoggerFactory.getLogger(mainstep6.class);
...
//        conf.set("mapreduce.textoutputformat.separator", ",");
        Job job = Job.getInstance(conf, "yago_parse_step6");
        job.setJarByClass(step6.class);
        job.setMapperClass(step6.step6YagoMap.class);
...
//        job.addCacheFile(new URI(fs + "/user/freebase/freebase_links_en.ttl"));
        job.addCacheFile(new URI(fs + "/user/yago/step5Result/part-r-00000"));
