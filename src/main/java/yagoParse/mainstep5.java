...
public class mainstep5 {
    ...
    public static Logger LOG = LoggerFactory.getLogger(mainstep5.class);
...
//        conf.set("mapreduce.textoutputformat.separator", ",");
        Job job = Job.getInstance(conf, "yago_parse_step5");
        job.setJarByClass(step5.class);
        job.setMapperClass(step5.step5YagoMap.class);
        job.setReducerClass(step5.step5YagoReduce.class);
