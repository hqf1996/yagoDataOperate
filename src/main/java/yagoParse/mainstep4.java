...
public class mainstep4 {
    ...
    public static Logger LOG = LoggerFactory.getLogger(mainstep4.class);
...
//        conf.set("mapreduce.textoutputformat.separator", ",");
        Job job = Job.getInstance(conf, "yago_parse_step4");
        job.setJarByClass(step4.class);
        job.setMapperClass(step4.step4YagoMap.class);
        job.setReducerClass(step4.step4YagoReduce.class);
