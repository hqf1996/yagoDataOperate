...
public class mainstep1 {
    ...
    public static Logger LOG = LoggerFactory.getLogger(mainstep1.class);
...
//        conf.set("mapreduce.textoutputformat.separator", ",");
        Job job = Job.getInstance(conf, "yago_parse_step1");
        job.setJarByClass(step1.class);
        job.setMapperClass(step1.step1YagoMap.class);
